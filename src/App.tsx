        ...
        <main className="flex-1 relative">
          ...
          <div className="absolute right-6 top-24 bottom-28 z-[1200] flex flex-col gap-4 w-80 pointer-events-none overflow-y-auto pr-2 no-scrollbar">
            ...
            <motion.div 
               ...
               className="glass-blue-pulse pointer-events-auto group shadow-[-20px_0_50px_rgba(0,0,0,0.3)] shrink-0"
            >
            ...
            {/* Route Analytics (formerly Accessibility Score Card) */}
            <motion.div 
               initial={{ x: 100, opacity: 0 }}
               animate={{ x: 0, opacity: 1 }}
               whileHover={{ perspective: 1000, rotateX: 2, rotateY: -2, z: 10 }}
               transition={{ type: 'spring', stiffness: 300, damping: 20 }}
               className="glass-pastel pointer-events-auto shrink-0"
            >
            ...
            <AnimatePresence>
              {isRerouted && (
                <motion.div 
                   ...
                   whileHover={{ perspective: 1000, scale: 1.05, rotateY: -3 }}
                   transition={{
                     y: { duration: 4, repeat: Infinity, ease: "easeInOut" },
                     type: 'spring', damping: 20
                   }}
                   exit={{ x: 100, opacity: 0 }}
                   className="glass-card-amber pointer-events-auto shrink-0 shadow-[0_0_30px_rgba(34,197,94,0.15)]"
                >
                    <div className="flex items-center justify-between mb-3">
            ...
            {/* Path Quality Card */}
            <div className="glass-card-cyan pointer-events-auto">
              <div className="flex items-center justify-between mb-4">
